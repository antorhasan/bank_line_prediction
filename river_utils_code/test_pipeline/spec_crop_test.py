...
path = "/media/antor/Files/ML/Papers/river_bank/JPEG_(copy)/inpain_test/20120218.jpg"
...
for i in range(len(only_need)):
    ...
    for k in range(24):
        ...
        for f in range(3):
            ...
            cv2.imwrite("/media/antor/Files/ML/Papers/river_bank/JPEG_(copy)/inpain_test/mini_gt/"+str(onlyn[i])+'_'+str(k)+'_'+str(f)+".jpg", crop_img)
            cv2.imwrite("/media/antor/Files/ML/Papers/river_bank/JPEG_(copy)/inpain_test/mini_msk/"+str(onlyn[i])+'_'+str(k)+'_'+str(f)+".jpg", crop_m)
